...
public class EditBookServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Book editBook = null;
        try {
            editBook = dao.findById(id);
        } catch (DAOException e) {
            e.printStackTrace();
            request.setAttribute("error", "Книга не найдена: " + e.getMessage());
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Book editBook = new Book(id, author, title, publishing, seriya, year, price);

        try {
            dao.update(editBook);
        } catch (DAOException e) {
            e.printStackTrace();
            request.setAttribute("error", "Ошибка при обновлении книги: " + e.getMessage());
        }
